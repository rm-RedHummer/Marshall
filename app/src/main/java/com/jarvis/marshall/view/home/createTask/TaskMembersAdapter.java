...
/**
 * Created by Jarvis on 24/02/2018.
 */

public class TaskMembersAdapter extends RecyclerView.Adapter<TaskMembersAdapter.ListHolder> {
    private Context context;
    private LayoutInflater inflater;
    private ArrayList<String> stringArrayList, positionArrayList;

    public TaskMembersAdapter(Context context, ArrayList<String> stringArrayList){
